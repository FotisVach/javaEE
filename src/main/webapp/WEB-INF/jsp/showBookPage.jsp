				...
				<div class="card mt-4">
					...
					<div class="card-body">
						<form:form>
							...
							<div class="form-group row">
								<label for="unitCost" class="col-form-label">Book unitCost :</label>
								<div class="col">
							...
							<div class="form-group row">
								...
								<div class="col">
									<input type="text" class="form-control" id="isbn"
										name="isbn" placeholder="${book.isbn}">
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								<label for="numberOfPages" class="col-form-label">Book unitCost :</label>
								<div class="col">
							...
							<div class="form-group row">
								<label for="imageUrl" class="col-form-label">Book imageUrl :</label>
								<div class="col">
							...
							<div class="form-group row">
								<label for="language" class="col-form-label">Book language :</label>
								<div class="col">
						...
						<a class="my-3 btn btn-primary btn-sm" href="/home">Return to home Page</a>
					</div>
